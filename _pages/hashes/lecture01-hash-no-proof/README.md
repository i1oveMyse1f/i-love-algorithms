...
Но вот беда, если $\left|\mathcal X\right| > P$, то по принципу Дирихле найдется хотя бы два разных объекта, которые имеют одинаковый хеш - такая ситуация называется **коллизией**.
